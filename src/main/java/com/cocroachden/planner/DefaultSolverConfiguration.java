...
public class DefaultSolverConfiguration {
  ...
  public static List<ConstraintRequestRecord> constraintRequests() {
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(1L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(2L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(3L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(4L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(5L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(6L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(7L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(8L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(9L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(10L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(11L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(12L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(13L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(14L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(15L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(16L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(17L), 50));
    ...
    allRequests.add(new TripleShiftConstraintRequest(new EmployeeId(18L), 50));
